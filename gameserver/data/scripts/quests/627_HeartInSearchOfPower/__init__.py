 ...
 def onEvent (self,event,st) :
   ...
   if event == "31518-1.htm" :
     ...
     if event == "31518-6.htm" :
       ...
       st.giveItems(ASOFE,int(26*Config.RATE_QUESTS_REWARD))
       st.giveItems(ADENA,6400)
     elif event == "31518-8.htm" :
       st.giveItems(THONS,int(26*Config.RATE_QUESTS_REWARD))
       st.giveItems(ADENA,6400)
     elif event == "31518-9.htm" :
       st.giveItems(ENRIA,int(12*Config.RATE_QUESTS_REWARD))
       st.giveItems(ADENA,13600)
     elif event == "31518-10.htm" :
       st.giveItems(MOLD_HARDENER,int(6*Config.RATE_QUESTS_REWARD))
